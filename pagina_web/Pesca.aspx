<%@ Page Title="" Language="C#" MasterPageFile="~/Plantilla.Master" AutoEventWireup="true" CodeBehind="Pesca.aspx.cs" Inherits="pagina_web.Produccion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="table-responsive"> 
         <h4> Mortalidad  </h4>
          <asp:GridView ID="tabla_pesca" class=" table table-dark " runat="server">
