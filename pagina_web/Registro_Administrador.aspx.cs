...
namespace pagina_web
{
    public partial class Registro_Administrador : System.Web.UI.Page
    {
        ...
        public void listar_administrador()
        {
            ...
            tabla_usuario.DataSource = pers_ad.Listado_Adminstrador();
        ...
        protected void btn_registrar_Click(object sender, EventArgs e)
        {
            ...
            if (respuesta > 0)
            {
                Response.Write("<script>alert('Se registro administrador' );</script>");
            }
            else
            {
                Response.Write("<script>alert(' No se registro administrador' );</script>");
            }
        }
