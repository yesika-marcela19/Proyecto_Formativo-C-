...
{
    public partial class Actividad_Alimentacion : Form
    {
        public Actividad_Alimentacion()
        {
            InitializeComponent();
            Listar_Estanques();
            Listar_persona();
        ...
        public void Listar_Alimentacion()
        {
            ...
            Tabla_Alimentacion.DataSource = vista.Listar_Calcular_Alimentacion();
        }
